...
var wheelImageName   = "/static/img/prizewheel.png";	// File name of the image for the wheel.
var spinButtonImgOn  = "/static/img/spin_on.png";		// Name / path to the images for the spin button.
var spinButtonImgOff = "/static/img/spin_off.png";
...
prizes[0] = {"name" : "Manu me leche les pieds", "startAngle" : 0,   "endAngle" : 44};  // Note how prize end angle is 1 less than start angle of next prize so no overlap.
prizes[1] = {"name" : "Manu avoue être un faible", "startAngle" : 45,  "endAngle" : 89};
prizes[2] = {"name" : "Manu nous offre a boire", "startAngle" : 90,  "endAngle" : 134};
