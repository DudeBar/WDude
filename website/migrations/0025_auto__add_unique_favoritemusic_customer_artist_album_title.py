...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'FavoriteMusic', fields ['customer', 'artist', 'album', 'title']
        db.create_unique(u'website_favoritemusic', ['customer_id', 'artist', 'album', 'title'])


    def backwards(self, orm):
        # Removing unique constraint on 'FavoriteMusic', fields ['customer', 'artist', 'album', 'title']
        db.delete_unique(u'website_favoritemusic', ['customer_id', 'artist', 'album', 'title'])
    ...
    models = {
        ...
        u'website.favoritemusic': {
            'Meta': {'unique_together': "(('customer', 'artist', 'album', 'title'),)", 'object_name': 'FavoriteMusic'},
