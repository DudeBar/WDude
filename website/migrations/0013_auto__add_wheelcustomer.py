...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WheelCustomer'
        db.create_table(u'website_wheelcustomer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('customer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.Customer'], null=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('launch', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'website', ['WheelCustomer'])


    def backwards(self, orm):
        # Deleting model 'WheelCustomer'
        db.delete_table(u'website_wheelcustomer')
