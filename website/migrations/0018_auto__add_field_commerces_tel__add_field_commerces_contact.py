...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Commerces.tel'
        db.add_column(u'website_commerces', 'tel',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True),
                      keep_default=False)

        # Adding field 'Commerces.contact'
        db.add_column(u'website_commerces', 'contact',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Commerces.tel'
        db.delete_column(u'website_commerces', 'tel')

        # Deleting field 'Commerces.contact'
        db.delete_column(u'website_commerces', 'contact')
