...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MusicTrack'
        db.create_table(u'website_musictrack', (
        ...
        db.send_create_signal(u'website', ['MusicTrack'])


    def backwards(self, orm):
        # Deleting model 'MusicTrack'
        db.delete_table(u'website_musictrack')
