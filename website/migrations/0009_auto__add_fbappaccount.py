...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FbAppAccount'
        db.create_table(u'website_fbappaccount', (
        ...
        db.send_create_signal(u'website', ['FbAppAccount'])


    def backwards(self, orm):
        # Deleting model 'FbAppAccount'
        db.delete_table(u'website_fbappaccount')
    ...
    models = {
        ...
        u'website.command': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 20, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
