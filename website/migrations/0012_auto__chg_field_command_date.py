...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Command.date'
        db.alter_column(u'website_command', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Command.date'
        db.alter_column(u'website_command', 'date', self.gf('django.db.models.fields.DateTimeField')())
