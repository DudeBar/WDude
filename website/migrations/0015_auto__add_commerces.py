...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Commerces'
        db.create_table(u'website_commerces', (
        ...
        db.send_create_signal(u'website', ['Commerces'])


    def backwards(self, orm):
        # Deleting model 'Commerces'
        db.delete_table(u'website_commerces')
