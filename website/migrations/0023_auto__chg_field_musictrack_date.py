...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MusicTrack.date'
        db.alter_column(u'website_musictrack', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'MusicTrack.date'
        raise RuntimeError("Cannot reverse this migration. 'MusicTrack.date' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'MusicTrack.date'
        db.alter_column(u'website_musictrack', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
