...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Customer.login'
        db.alter_column(u'website_customer', 'login', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Customer.login'
        db.alter_column(u'website_customer', 'login', self.gf('django.db.models.fields.CharField')(max_length=20))
