...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Commerces.livraison'
        db.add_column(u'website_commerces', 'livraison',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Commerces.livraison'
        db.delete_column(u'website_commerces', 'livraison')
