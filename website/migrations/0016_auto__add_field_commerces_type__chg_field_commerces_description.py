...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Commerces.type'
        db.add_column(u'website_commerces', 'type',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)


        # Changing field 'Commerces.description'
        db.alter_column(u'website_commerces', 'description', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Commerces.type'
        db.delete_column(u'website_commerces', 'type')


        # Changing field 'Commerces.description'
        db.alter_column(u'website_commerces', 'description', self.gf('django.db.models.fields.TextField')(default=None))
    ...
    models = {
        ...
        u'website.commerces': {
            ...
            'website': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '200'})
        },
        u'website.customer': {
