...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MusicTrack.date'
        db.add_column(u'website_musictrack', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 3, 5, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MusicTrack.date'
        db.delete_column(u'website_musictrack', 'date')
